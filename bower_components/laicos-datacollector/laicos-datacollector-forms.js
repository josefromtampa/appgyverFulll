    ...
    angular.module('laicos.datacollector.forms', [])
        .factory('forms', function () {
            ...
            var _comparer = {
                ...
                gtez: function (value, dependencyVal) {
                    return value >= dependencyVal || value === 0;
                },
            ...
            var _validator = {
                ...
                gtez: function (value, compareValue) {
                    try {
                        return parseFloat(value) >= parseFloat(compareValue) || value === 0;
                    } catch (e) {
